    ...
    <div className="w-full">
      ...
      <div className="grid grid-cols-3 gap-8 mb-8">
        <Link to="#" className="flex items-center gap-4">
          <span className="w-16 h-16 rounded-full bg-[#e94b6a] flex items-center justify-center"><img src="/bezzy.svg" alt="Bezzy" className="w-10 h-10" loading="lazy" onError={(e: any) => { e.currentTarget.src = '/placeholder.svg'; }} /></span>
          <span className="text-xl font-semibold">Breast Cancer</span>
        </Link>
        <Link to="#" className="flex items-center gap-4">
          <span className="w-16 h-16 rounded-full bg-[#f28c28] flex items-center justify-center"><img src="/bezzy.svg" alt="Bezzy" className="w-10 h-10" loading="lazy" onError={(e: any) => { e.currentTarget.src = '/placeholder.svg'; }} /></span>
          <span className="text-xl font-semibold">Multiple Sclerosis</span>
        </Link>
        <Link to="#" className="flex items-center gap-4">
          <span className="w-16 h-16 rounded-full bg-[#0082c8] flex items-center justify-center"><img src="/bezzy.svg" alt="Bezzy" className="w-10 h-10" loading="lazy" onError={(e: any) => { e.currentTarget.src = '/placeholder.svg'; }} /></span>
