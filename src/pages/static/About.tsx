...
const About = () => {
  return (
    <StaticPage 
      title="About SixHealth" 
      description="Empowering you with trusted, evidence-based health information."
    >
      <p>
        SixHealth is your dedicated partner in wellness, offering comprehensive, medically-reviewed information
        to help you make informed decisions about your health.
      </p>
      <h2>Who We Are</h2>
      <p>
        We are a team of medical professionals, health writers, and patient advocates committed to 
        demystifying healthcare. In a world of misinformation, SixHealth stands as a beacon of trust, 
