...
const BlackHealth: React.FC = () => {
  const article = blogData.find((p) => p.slug === "black-health");
    ...
    <Layout>
      <div className="bg-white min-h-screen text-gray-900">
        <div className="max-w-3xl mx-auto px-4 py-12">
          <h1 className="text-3xl font-bold mb-4">Black Health</h1>
          <p className="text-gray-700">Resources and articles focused on Black health and wellness, including culturally relevant care, prevention, and community resources.</p>
        </div>
      </div>
    </Layout>
  );
